...
class CheckSuite(unittest.TestCase):
    ...
    def test1(self):
        ...
        EndBody.
        """
        expect = str(IndexOutOfRange(ArrayCell(Id('x'),[Id('n'),BinaryOp('+',BinaryOp('-',BinaryOp('+',BinaryOp('\\',IntLiteral(3),IntLiteral(4)),BinaryOp('*',IntLiteral(1),IntLiteral(2))),BinaryOp('%',IntLiteral(10),IntLiteral(4))),IntLiteral(2))])))
    ...
    def test3(self):
        ...
        input = """
                  ...
                  EndBody.
                  """
        expect = str(IndexOutOfRange(ArrayCell(CallExpr(Id('main'),[IntLiteral(1),IntLiteral(2),IntLiteral(3)]),[IntLiteral(2),IntLiteral(2)])))
    ...
    def test4(self):
        ...
        input = """
            ...
            Function: main
                ...
                EndBody.
        """
        expect = str(UnreachableFunction('sub_func'))
    ...
    def test6_main_func_between_function(self):
        """Complex program"""
        input = """
            Function: main_
            Body:
            ...
            EndBody.
        """
        expect = str(UnreachableFunction('main_'))
    ...
    def test8_complex_program_from_check_suite(self):
        """More complex program"""
        input = """
                  Function: fact
                  Parameter: n
                  ...
                  EndBody.
                  """
        expect = str(IndexOutOfRange(ArrayCell(Id('x'),[IntLiteral(1)])))
    ...
    def test9(self):
        ...
        input = """
                  ...
                  """
        expect = str(UnreachableStatement(CallStmt(Id("print"),[StringLiteral("hi")])))
    ...
    def test11(self):
        ...
        input = """Function: foo1
                  ...
                  EndBody.
                  """
        expect = str(UnreachableStatement(Assign(Id('x'),FloatLiteral(2.2))))
    ...
    def test12(self):
        ...
        input = """Function: foo1
                  ...
                  EndBody.
                  """
        expect = str(UnreachableStatement(CallStmt(Id('print'),[CallExpr(Id('string_of_int'),[Id('i')])])))
