...
class CheckSuite(unittest.TestCase):
    ...
    def test_match_type_of_parameter_call_expr(self):
        ...
        input = """
            ...
            EndBody.
        """
        expect = str(TypeMismatchInExpression(BinaryOp('+', IntLiteral(1), CallExpr(Id('foo'), [IntLiteral(1), FloatLiteral(1.1), StringLiteral("")]))))
    ...
    def test_invalid_return_in_(self):
        ...
        input = """
            ...
            EndBody.
        """
        expect = str(TypeMismatchInStatement(CallStmt(Id('foo'), [IntLiteral(1), FloatLiteral(1.1), BooleanLiteral(False)])))
    ...
    def test_invalid_index_expression_with_funccallStmt(self):
        ...
        input = """
                  ...
                  EndBody.
                  """
        expect = str(TypeMismatchInStatement(Assign(ArrayCell(CallExpr(Id('foo'), []), [IntLiteral(0)]), FloatLiteral(1.1))))
    ...
    def test_multi_func_return_array(self):
        ...
        input = """
                  ...
                  EndBody.
                  """
        expect = str(TypeCannotBeInferred(Assign(ArrayCell(CallExpr(Id('foo'), []), [IntLiteral(0), IntLiteral(0)]), FloatLiteral(0.9))))
    ...
    def test_inferred_ele_type_in_binary_op(self):
        ...
        input = """
                  ...
                  EndBody.
                  """
        expect = str(TypeCannotBeInferred(BinaryOp('+', IntLiteral(1), ArrayCell(CallExpr(Id('foo'), []), [IntLiteral(2)]))))
    ...
    def test_same_type_array_2(self):
        ...
        input = """
                  ...
                  EndBody.
                  """
        expect = str(TypeMismatchInStatement(Assign(ArrayCell(Id('a'), [IntLiteral(0), IntLiteral(0), IntLiteral(0)]), BooleanLiteral(True))))
    ...
    def test_type_cannot_be_infer(self):
        """More complex program"""
        input = """
                  Function: main
                  Body:
                  ...
                  EndBody.
                  """
        expect = str(TypeCannotBeInferred(Assign(Id('c'), Id('d'))))
        self.assertTrue(TestChecker.test(input, expect, 504))

    def test_order_infer(self):
        """More complex program"""
        input = """
                  Function: foo
                  Parameter: x
    ...
    def test_order_infer_4(self):
        ...
        input = """
                  ...
                  """
        expect = str(TypeMismatchInExpression(CallExpr(Id('foo'), [FloatLiteral(1.0)])))
        self.assertTrue(TestChecker.test(input, expect, 508))

    def test_scalar_type_is_void_type(self):
        """More complex program"""
        input = """
                  Function: foo
                  Body:
    ...
    def test_infer_param_from_for_stmt(self):
        """More complex program"""
        input = """
                  Var: k;
                  Function: foo
                  ...
                  """
        expect = str(TypeMismatchInStatement(CallStmt(Id('foo'), [IntLiteral(1), BooleanLiteral(True), StringLiteral("")])))
        self.assertTrue(TestChecker.test(input, expect, 510))

    def test_infer_param_from_if_stmt(self):
        """More complex program"""
        input = """
                  Var: k;
                  Function: foo
                  ...
                  """
        expect = str(TypeMismatchInExpression(CallExpr(Id('foo'), [IntLiteral(1), IntLiteral(1), StringLiteral("")])))
        self.assertTrue(TestChecker.test(input, expect, 511))

    def test_infer_param_from_dowhile_stmt(self):
        """More complex program"""
        input = """
                  Var: k;
                  Function: foo
    ...
    def test_infer_param_from_while_stmt(self):
        """More complex program"""
        input = """
                  Var: k;
                  Function: foo
    ...
    def test_infer_return_type_from_while_stmt(self):
        """More complex program"""
        input = """
                  Var: k;
                  Function: foo
    ...
    def test_invalid_index_operator(self):
        ...
        input = """
                  ...
                  """
        expect = str(TypeMismatchInExpression(ArrayCell(CallExpr(Id('foo'),[IntLiteral(1), IntLiteral(1), StringLiteral("")]), [IntLiteral(1)])))
